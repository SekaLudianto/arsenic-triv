...
const KnockoutRegistrationScreen: React.FC<KnockoutRegistrationScreenProps> = ({ players, maxPlayers, onEndRegistration, onResetRegistration, champions, isSimulation }) => {
    ...
    >
      <div className="text-center shrink-0">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">
            {isFull ? <span className="text-red-500 font-bold">PENDAFTARAN PENUH!</span> : 'Pendaftaran dibuka!'}
        </p>
      ...
      <div className="flex gap-2 my-2 shrink-0">
          ...
          >
              ...
              Pendaftar ({players.length}/{maxPlayers})
          </button>
          <button
