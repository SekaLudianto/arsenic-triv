...
const App: React.FC = () => {
  ...
  const handleStartKnockout = useCallback((category: KnockoutCategory, useImportedOnly: boolean, maxPlayers: number) => {
    game.startGame(GameStyle.Knockout, maxWinners, { knockoutCategory: category, useImportedOnly, maxPlayers });
  }, [game, maxWinners]);
