...
export const KNOCKOUT_PREPARE_SECONDS = 10; // Diubah dari 5 ke 10 detik
export const KNOCKOUT_WINNER_VIEW_SECONDS = 10; // Diubah dari 5 ke 10 detik
export const KNOCKOUT_ROUND_TIMER_SECONDS = 30;

export const GAME_OVER_RESTART_DELAY_SECONDS = 30;
export const ANSWER_REVEAL_DELAY_SECONDS = 3;
